...
public class MarkdownConfiguration <T extends DingtalkBuild> {
    ...
    private static final String ONE_TITLE_FORMAT = NEW_LINE + "# %s" + NEW_LINE;
    private static final String TWO_TITLE_FORMAT = NEW_LINE + "## %s" + NEW_LINE;
    private static final String THREE_TITLE_FORMAT = NEW_LINE + "### %s" + NEW_LINE;
    private static final String FOUR_TITLE_FORMAT = NEW_LINE + "#### %s" + NEW_LINE;
    private static final String FIVE_TITLE_FORMAT = NEW_LINE + "##### %s" + NEW_LINE;
    private static final String SIX_TITLE_FORMAT = NEW_LINE + "###### %s" + NEW_LINE;
